...
import {SpecializationSearchProps} from 'types/user';
import qs from 'qs';
...
const SearchSpecialization: ForwardRefRenderFunction<refProps, props> = (
  props: props,
  ...
  const onFinish = (values: SpecializationSearchProps) => {
    history.replace({
...
export default forwardRef(SearchSpecialization);
